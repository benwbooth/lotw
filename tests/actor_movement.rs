...
fn project_actor_position_applies_subtile_carry_and_vertical_velocity() {
    ...
    engine.state.obj_x_sub = 0x03;
    engine.state.obj_x_tile = 0x10;
    engine.state.obj_y_pixel = 0x50;
    engine.state.obj_x_vel_lo = 0x0E;
    engine.state.obj_x_vel_hi = 0x00;
    engine.state.obj_y_vel = 0x02;
...
fn commit_and_stop_actor_helpers_update_scratch_motion_state() {
    ...
    engine.state.indirect_ptr_lo = 0x04;
    engine.state.indirect_ptr_hi = 0x22;
    engine.state.scratch2 = 0x66;
    engine.state.obj_x_vel_lo = 0x01;
    engine.state.obj_y_vel = 0x02;
    engine.state.obj_cooldown = 0x03;
    engine.state.obj_move_scratch = 0x04;
...
fn reverse_actor_horizontal_direction_flips_low_direction_bits() {
    ...
    engine.state.obj_move_state = 0x01;
...
fn update_actor_animation_dispatches_room_animation_mode() {
    ...
    engine.state.obj_timer = 0x02;
    engine.state.obj_tile = 0xF3;
...
fn apply_actor_player_contact_damage_updates_health_and_hit_state() {
    ...
    engine.state.obj_attr = 0xFF;
    engine.state.obj_damage = 0x02;
...
fn try_move_large_actor_with_terrain_uses_wide_probe_and_restores_vertical_velocity() {
    ...
    engine.state.obj_x_vel_hi = 0x00;
    engine.state.obj_y_vel = 0x04;
    engine.state.obj_x_sub = 0x00;
    engine.state.obj_x_tile = 0x20;
    engine.state.obj_y_pixel = 0x50;
...
fn compose_large_actor_body_slots_syncs_linked_sprite_state() {
    ...
    engine.state.prg_bank_8000 = 0xAA;
    engine.state.prg_bank_a000 = 0xBB;
    engine.state.obj_state = 0x01;
    engine.state.obj_tile = 0x41;
    engine.state.obj_attr = 0x02;
    engine.state.obj_health = 0x09;
    engine.state.obj_x_sub = 0x03;
    engine.state.obj_x_tile = 0x20;
    engine.state.obj_y_pixel = 0x50;
    engine.state.obj_y_extra = 0x77;
