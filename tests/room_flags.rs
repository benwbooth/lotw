...
fn room_persistent_flag_read_and_clear_use_current_map_bit() {
    ...
    engine.state.map_screen_x = 0x02;
    engine.state.map_screen_y = 0x00;
    ...
    engine.state.map_screen_x = 0x03;
    engine.state.map_screen_y = 0x02;
...
fn family_item_permission_bits_return_shifted_value_and_carry() {
    ...
    engine.state.character_index = 0x00;
    engine
        .state
