...
fn room_palette_buffer_copies_room_bytes_and_family_override() {
    ...
    engine.state.palette_src_ptr_lo = 0x00;
    engine.state.palette_src_ptr_hi = 0xB0;
    engine.state.character_index = 0x02;
...
fn upload_title_screen_nametables_copies_rom_pages_and_chr_banks() {
    ...
    engine.state.ppu_ctrl_shadow = 0xAB;
