...
.segment "CODE13"
; ==== title_credits_nametable (data) @ $A000 ====
...
L_B0A6:
    JSR $C461
    JMP L_AE64
; ==== per_character_carried_item_table (data) @ $B0AC ====
    .byte $03,$04,$05,$02,$08
L_B0B1:
    JSR $C461
    LDA #$8B
...
L_B493:
    ...
    LDX #$01
    RTS
; ==== gameover_menu_text (text, ASCII+$A0) @ $B4AF ====
...
L_B6F2:
    ...
    BPL L_B6F2
    RTS
; ==== oam_tables_and_credits_nametable (data) @ $B6FC ====
...
; ==== ending_credits_text (text) @ $B79C ====
    ...
    .byte $2C,$20,$49,$6E,$63,$2E,$0D,$0D,$0D,$0D,$0D,$0D,$0D
; ==== bank13_zero_pad (data) @ $BD89 ====
    .byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00
    .byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00
    .byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00
    .byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00
